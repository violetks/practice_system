...
<div id="table_area">
    <table border="0" align="center">
        ...
        <tr align="center">
            ...
            <td><%=programDao.getResolvedCount(s.getSid(),0,4,1) %></td>
        ...
        <tr align="center">
            ...
            <td><%=programDao.getResolvedCount(s.getSid(),1,4,1) %></td>
        ...
        <tr align="center">
            ...
            <td><%=programDao.getResolvedCount(s.getSid(),2,4,1) %></td>
        ...
        <tr align="center">
            ...
            <td><%=programDao.getResolvedCount(s.getSid(),3,4,1) %></td>
