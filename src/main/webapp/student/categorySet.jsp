...
<div id="choose_box">
    ...
    <div class="choose_test">
        <div class="box">
            <a href="${pageContext.request.contextPath}/student/chooseSet.jsp">
                <p id="choose_p">选择题</p>
                <p class="btn">进入试题</p>
            </a>
        </div>
        <div class="box">
            <a href="${pageContext.request.contextPath}/student/fillblankSet.jsp">
                <p id="fill_p">填空题</p>
                <p class="btn">进入试题</p>
            </a>
        </div>
        <div class="box">
            <a href="${pageContext.request.contextPath}/student/programSet.jsp">
