...
<!-- 左边试题详情部分 -->
<div id="left_box">
    <a id="first_a" onclick="javascript:history.back(-1);">返回试题集</a>
    <div id="question_content">
        <h2 style="display: inline;">题目名称：</h2>
        <span><%=question.getqName()%></span><span>（<%=question.gettScore()%>分）</span><br>
        <h2>题目描述</h2>
...
<div id="right_box">
    ...
    <form name="form" action="${pageContext.request.contextPath}/CompileRunServlet" method="post" onsubmit="getCode()">
        <p><textarea id="codeArea" name="codeStr" rows="20" cols="60" placeholder="源代码提交时注意：
                1.import语句不能少;
                2.删掉代码中的package;"></textarea></p>
        <input type="submit" class="add_btn" value="提交代码"/>
    </form>
</div>
